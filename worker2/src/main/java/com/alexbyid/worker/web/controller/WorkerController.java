...
public class WorkerController {
    ...
    @PostMapping("/solve")
    public ResponseEntity<ApiResponse> solve(@RequestBody TaskRequest taskRequest) {
        log.info("Received task: {}:{}", taskRequest.getStart(), taskRequest.getCount());
        workerService.solve(taskRequest);
